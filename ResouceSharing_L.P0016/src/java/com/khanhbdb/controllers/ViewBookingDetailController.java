...
public class ViewBookingDetailController extends HttpServlet {
    ...
    private final static String SUCCESS = "manager_view_booking_detail.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BookingDTO dto = bookingDao.getBookingById(bookingId);
            HttpSession session = request.getSession();
            session.setAttribute("BOOKINGDETAIL", dto);
        } catch (Exception e) {      
